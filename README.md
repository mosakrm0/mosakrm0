...
* **Web App CI/CD Deployment:** Containerized a Python Flask app and deployed it on a local Kubernetes cluster (Minikube) with an automated GitHub Actions pipeline.
* **Jenkins CI/CD Pipeline:** Configured a Linux-based Jenkins server with automated pipelines and system cleanup tasks to manage Docker image building and deployment.
